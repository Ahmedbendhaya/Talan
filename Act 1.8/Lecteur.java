...
public class Lecteur {
	...
	public static void main(String[] args) {
		File file= new File("Musique.doc");
	...
	public void Enregistrement() {
		try {
		File file1= new File("Musique.doc");
		File file2= new File("User Musique1.doc");
		FileWriter filewriter = new FileWriter("User Musique1.doc");
